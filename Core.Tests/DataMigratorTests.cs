	...
	public class DataMigratorTests {
		...
		public void MigrateUsersStorageProviderData() {
			...
			Expect.Call(destination.AddUser(u1.Username, u1.DisplayName, null, u1.Email, u1.Active, u1.DateTime)).Return(u1Out).Constraints(
				Rhino.Mocks.Constraints.Is.Equal(u1.Username), Rhino.Mocks.Constraints.Is.Equal(u1.DisplayName), Rhino.Mocks.Constraints.Is.Anything(), Rhino.Mocks.Constraints.Is.Equal(u1.Email), Rhino.Mocks.Constraints.Is.Equal(u1.Active), Rhino.Mocks.Constraints.Is.Equal(u1.DateTime));
			Expect.Call(destination.AddUser(u2.Username, u2.DisplayName, null, u2.Email, u2.Active, u2.DateTime)).Return(u2Out).Constraints(
				Rhino.Mocks.Constraints.Is.Equal(u2.Username), Rhino.Mocks.Constraints.Is.Equal(u2.DisplayName), Rhino.Mocks.Constraints.Is.Anything(), Rhino.Mocks.Constraints.Is.Equal(u2.Email), Rhino.Mocks.Constraints.Is.Equal(u2.Active), Rhino.Mocks.Constraints.Is.Equal(u2.DateTime));
			Expect.Call(destination.AddUser(u3.Username, u3.DisplayName, null, u3.Email, u3.Active, u3.DateTime)).Return(u3Out).Constraints(
				Rhino.Mocks.Constraints.Is.Equal(u3.Username), Rhino.Mocks.Constraints.Is.Equal(u3.DisplayName), Rhino.Mocks.Constraints.Is.Anything(), Rhino.Mocks.Constraints.Is.Equal(u3.Email), Rhino.Mocks.Constraints.Is.Equal(u3.Active), Rhino.Mocks.Constraints.Is.Equal(u3.DateTime));
