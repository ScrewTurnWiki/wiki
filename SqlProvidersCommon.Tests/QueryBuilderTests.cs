namespace SqlProvidersCommon.Tests
{
	...
	public class QueryBuilderTests
	{
		...
		{
			ICommandBuilder builder = _mocks.StrictMock<ICommandBuilder>( );
		...
		{
			string query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).SelectFrom( "Table", new[ ] { "Col1", "Col2" } );
		...
		{
			string query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).SelectFrom(
				"Table", "Joined", new[ ] { "Col1", "Col2" }, new[ ] { "Col3", "Col4" }, Join.RightJoin,
				new[ ] { "Col6", "Col7" }, new[ ] { "Col8", "Col9" } );
		...
		public void SelectFrom_ColumnsJoin2( )
		{
			string query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).SelectFrom(
				...
				new[ ] { "Col1", "Col2" }, new[ ] { "Col4", "Col6" },
				"Table3", "Col5", Join.LeftJoin, new[ ] { "Col34" } );
		...
		public void WhereIn_NamedParameters( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).WhereIn( query, "Col1", new[ ] { "Param1", "Param2" } );
		...
		public void WhereIn_UnnamedParameters( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithoutNamedParameters( ) ).WhereIn( query, "Col1", new[ ] { "Param1", "Param2" } );
		...
		public void WhereIn_Table_NamedParameters( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).WhereIn( query, "Table", "Col1", new[ ] { "Param1", "Param2" } );
		...
		public void WhereIn_Table_UnnamedParameters( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithoutNamedParameters( ) ).WhereIn( query, "Table", "Col1", new[ ] { "Param1", "Param2" } );
		...
		public void OrderBy( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).OrderBy( query, new[ ] { "Col1", "Col2", "Col3" }, new[ ] { Ordering.Asc, Ordering.Desc, Ordering.Asc } );
		...
		public void GroupBy( )
		{
			...
			query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).GroupBy( query, new[ ] { "Col2", "Col1" } );
		...
		public void InsertInto_NamedParameters( )
		{
			string query = QueryBuilder.NewQuery( MockCommandBuilderWithNamedParameters( ) ).InsertInto( "Table",
				new[ ] { "Col1", "Col2" }, new[ ] { "Param1", "Param2" } );
